...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    def _create_classes_dex(self):
        ...
        # DEX file header
        dex_data = bytearray(256 * 1024)  # Standard DEX size

        # DEX magic and version
        dex_data[0:8] = b'dex\n038\x00'

        # File size
        dex_data[32:36] = (256 * 1024).to_bytes(4, 'little')
        ...
        dex_data[52:56] = (256 * 1024 - 12).to_bytes(4, 'little')
